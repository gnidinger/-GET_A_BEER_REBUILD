...
public class GoogleService {
	...
	public Mono<User> doFilter(String code) {
	...
	public Mono<User> createUser(HashMap<String, Object> userInfo) {
		...
		return findUserMono.flatMap(findUser -> {
			if (findUser != null && findUser.getProvider() != null && findUser.getProvider().equals("GOOGLE")) {
